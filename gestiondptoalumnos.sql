...
INSERT INTO `tramite_movimientos` ('id', `id_tramite`, `fecha_movimiento`, `id_usuario`, `observacion`, `id_estado_tramite`) VALUES
(1, 1, '11-10-2024', 1, 'Cambio de estado a pendiente', 1),
(2, 2, '11-10-2024', 1, 'Cambio de estado a pendiente', 1),
(3, 1, '12-10-2024', 1, 'Cambio de estado a en proceso', 1);
...
ALTER TABLE `tramite_movimientos`
  ADD PRIMARY KEY (`id`,`fecha_movimiento`),

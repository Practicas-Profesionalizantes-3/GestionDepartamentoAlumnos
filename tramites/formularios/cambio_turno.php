            ...
            <div class="tm-main">
                <div class="tm-section-wrap mt-3 border-dark">
                    ...
                    <form class="container mt-5" id="formulario">
                        ...
                        <div class="mb-3">
                            <label for="turno" class="form-label">Seleccione su Turno Actual:</label>
                        ...
                        <div class="mb-3">
                            <label for="nuevo_turno" class="form-label">Nuevo de Turno:</label>
                            <select class="form-control" name="nuevo_turno" id="nuevo_turno">
                                <option value="1" selected>Turno Mañana</option>
                                <option value="1">Turno Tarde</option>
                                <option value="2">Turno Noche</option>
                            </select>
                        ...
                        <input type="text" readonly hidden value="4" id="id_tramite_tipo" />
                    </form>
                </div> <!-- .tm-section-wrap -->
            </div> <!-- .tm-main -->
        </div> <!-- .row -->

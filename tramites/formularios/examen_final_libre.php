                ...
                <div class="tm-section-wrap mt-3 border-dark">
                    ...
                    <form class="container mt-5" id="formulario">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="date" class="form-control" name="fecha_examen" id="fecha_examen" aria-describedby="helpId" placeholder="Fecha de examen" required value="<?php $hoy = date("Y-m-d"); echo $hoy; ?>">
                        </div>
                        <div class="mb-3">
                            <label for="docente" class="form-label">Docente:</label>
                            <input type="text" class="form-control" name="docente" id="docente" aria-describedby="helpId" placeholder="Docente">
                        </div>
                        <div class="mb-3">
                            <label for="mail" class="form-label">Email:</label>
                            <input type="mail" class="form-control" name="mail" id="mail" aria-describedby="helpId" placeholder="Email">
                        </div>
                        <div class="mb-3">
